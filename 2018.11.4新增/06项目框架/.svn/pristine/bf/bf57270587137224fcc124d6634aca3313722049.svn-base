<%@ Page Title="" Language="C#" MasterPageFile="~/Background/Common/Default.Master" AutoEventWireup="true" CodeFile="CookbookPreferentialInRankManager.aspx.cs" Inherits="Background_Cookbook_CookbookPreferentialInRankManager" %>
