<%@ Page Title="警员优惠管理" Language="C#" MasterPageFile="~/Background/Common/Default.Master" AutoEventWireup="true" CodeFile="CookbookPreferentialInRankManager.aspx.cs" Inherits="Background_Cookbook_CookbookPreferentialInRankManager" %>
        ...
        <asp:GridView ID="gdUserCookbook" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" Width="98%"
            ...
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "CookbookPreferentialInRankItemsManager.aspx?id=" + DataBinder.Eval(Container.DataItem,"Id") %>'>
