<%@ Page Title="警员优惠添加" Language="C#" MasterPageFile="~/Background/Common/Default.Master" AutoEventWireup="true" 
    CodeFile="CookbookPreferentialInRankAdd.aspx.cs" Inherits="Background_Cookbook_CookbookPreferentialInRankAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="content" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td class="input1">
                <asp:DropDownList ID="ddlRank" runat="server" DataTextField="Name" DataValueField="Id" Height="26px" /></td>
        </tr>
