...
public partial class Background_Staff_WorkerStaffManager : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "Remove":
                _staffBLL.RemoveWorkerStaff(id);
                bindList(PageUtility.NAVIGATION_DEFAULT_PAGEINDEX, PageUtility.NAVIGATION_DEFAULT_PAGESIZE);
                break;
        }
    }
    ...
    private void bindList(int pageIndex, int pageSize)
    {
        ...
        GridView1.DataSource = _staffBLL.GetWorkerStaffList(string.Empty, loginedUser.OrganizationId, null, "order by DisplayOrder Desc", pageIndex, pageSize, out total);
        GridView1.DataBind();
    ...
    {
        Response.Redirect("WorkerStaffAdd.aspx");
    }
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            var cafeInfo = e.Row.DataItem as WorkersStaffInfo;
            if (cafeInfo == null)
                return;
