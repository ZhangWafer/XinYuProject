<%@ Page Title=" 工作人员添加" Language="C#" MasterPageFile="~/Background/Common/Default.Master"
    AutoEventWireup="true" CodeFile="WorkerStaffAdd.aspx.cs" Inherits="Background_Staff_WorkerStaffAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="content" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td class="input1">
                <asp:TextBox ID="txtInformationNum" runat="server" Width="250px" MaxLength="100" Height="24px" />
        ...
        <tr>
            ...
            <td class="input1">
                <asp:Label ID="lblOrganizationName" runat="server" Text="" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="input2">
                <asp:TextBox ID="txtName" runat="server" Width="100px" MaxLength="100" Height="24px"></asp:TextBox><span class="alert">*必填项</span></td>
        </tr>
        ...
        <tr>
            ...
            <td class="input2">
                <asp:TextBox ID="txtTel" runat="server" Width="150px" MaxLength="100" Height="24px"></asp:TextBox></td>
        </tr>

        <tr>
            <td class="title1">微信号：</td>
            <td class="input1">
                <asp:TextBox ID="txtWechat" runat="server" Width="150px" MaxLength="100" Height="24px"></asp:TextBox></td>
        </tr>
