...
<body style="overflow: hidden; position: absolute; width: 100%; height: 100%;">
    <form id="form1" runat="server">
        <div id="divBody" style="overflow: hidden; position: absolute; width: 100%; height: 100%;">
                ...
                <div id="divBannerStatus">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" style="margin-right: 20px; float: right;">
                        <tr>
                            ...
                            <td class="center">
                                <img alt="" src="img/framework/banner_user_updpwd.gif" width="16" height="8" align="absmiddle" /><a href="SysManager/UserUpdPwd.aspx" class="b1" target="main">修改密码</a></td>
                            <td class="center">
                                <img alt="" src="img/framework/banner_user_logout.gif" width="13" height="14" align="absmiddle" /><a href="Default.aspx" class="b1">安全退出</a></td>
            ...
            <div id="divFooter">
                <div style="margin-top: 4px;">Copyright (C) 2018 All rights reserved.</div>
            </div>
        </div>
