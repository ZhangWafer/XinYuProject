<%@ Page Title="" Language="C#" MasterPageFile="~/Background/Common/Default.Master" AutoEventWireup="true" CodeFile="PCStaffAdd.aspx.cs" Inherits="Background_Staff_PCStaffAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="title" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="right" align="right">
                <asp:LinkButton ID="lnkAddHeader" runat="server" OnClick="lnkAddRole_Click"><img alt="" src="../img/edit/add.gif" border="0" align="absmiddle" />返回警务人员管理</asp:LinkButton>
            </td>
        </tr>
    </table>
    <table class="content" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="title1">警衔：</td>
            <td class="input1">
                <asp:DropDownList ID="ddlRank" runat="server" DataTextField="Name" DataValueField="Id" Height="26px" /><span class="alert">*必填项</span></td>
        </tr>

        <tr>
            <td class="title2">警号：</td>
            <td class="input2">
                <asp:TextBox ID="txtPCNum" runat="server" Width="250px" MaxLength="100" Height="24px"></asp:TextBox><span class="alert">*必填项</span></td>
        </tr>
