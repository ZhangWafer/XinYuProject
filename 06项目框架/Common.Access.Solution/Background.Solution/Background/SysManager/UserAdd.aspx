...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="title" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="left">
                <img alt="" src="../img/edit/warning.gif" border="0" align="absMiddle" /><span class="fontred">*</span><span class="fontblack">为必填项</span></td>
    ...
    <table class="content" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="input1">
                <asp:CheckBoxList ID="chklstRoleList" runat="server" RepeatDirection="Horizontal"></asp:CheckBoxList><span class="alert"></span></td>
        </tr>
        <tr>
            <td class="title2" style="width: 100px">登录账号：</td>
            <td class="input2">
                <asp:TextBox ID="txtUserName" runat="server" Width="200px"></asp:TextBox><span class="alert">*</span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="title2" style="width: 100px">管理机构：</td>
            <td class="input2" style="width: 300px">
                <asp:DropDownList ID="ddlOrg" runat="server" DataTextField="Name" DataValueField="Id" /><span class="alert">*</span></td>
        </tr>
        <tr>
            <td class="title1" style="width: 100px">用户姓名：</td>
            <td class="input1" style="width: 300px">
                <asp:TextBox ID="txtAlias" runat="server" Width="200px"></asp:TextBox><span class="alert">*</span></td>
        </tr>
        <tr>
            <td class="title2" style="width: 100px">用户邮箱：</td>
            <td class="input2" style="width: 300px">
                <asp:TextBox ID="txtEmail" runat="server" Width="200px"></asp:TextBox><span class="tip"></span></td>
        </tr>
        <tr>
            <td class="title1" style="width: 100px"></td>
            <td class="input1">
                <asp:CheckBox ID="cbxIsLockout" runat="server" Text="锁定账号（锁定后用户无法登录）" /></td>
        </tr>
        <tr>
            <td class="title2" style="width: 100px">用户描述：</td>
            <td class="input2" colspan="3">
