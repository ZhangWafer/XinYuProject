<%@ Page Title="" Language="C#" MasterPageFile="~/Background/Common/Default.Master" AutoEventWireup="true" CodeFile="OrganizationAdd.aspx.cs" Inherits="Background_Organization_OrganizationAdd" %>
    ...
    <table class="title" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="right" align="right">
                <asp:LinkButton ID="lnkAddHeader" runat="server" OnClick="lnkAddRole_Click"><img alt="" src="../img/edit/add.gif" border="0" align="absmiddle" />返回机构管理</asp:LinkButton>
            </td>
        </tr>
    </table>
